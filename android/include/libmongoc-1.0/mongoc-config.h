...
#define MONGOC_USER_SET_CFLAGS "-isystem D:/project/Android-NDK-r17b/android-ndk-r17b/sysroot/usr/include/arm-linux-androideabi -D__ANDROID_API__=14 -g -DANDROID -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -mthumb -Wa,--noexecstack -Wformat -Werror=format-security "

#define MONGOC_USER_SET_LDFLAGS "-Wl,--exclude-libs,libgcc.a -Wl,--exclude-libs,libatomic.a -nostdlib++ --sysroot D:/project/Android-NDK-r17b/android-ndk-r17b/platforms/android-14/arch-arm -Wl,--build-id -Wl,--warn-shared-textrel -Wl,--fatal-warnings -Wl,--fix-cortex-a8 -Wl,--exclude-libs,libunwind.a -LD:/project/Android-NDK-r17b/android-ndk-r17b/sources/cxx-stl/llvm-libc++/libs/armeabi-v7a -Wl,--no-undefined -Wl,-z,noexecstack -Qunused-arguments -Wl,-z,relro -Wl,-z,now -Wl,--gc-sections -Wl,-z,nocopyreloc "

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "D:/project/Android-NDK-r17b/android-ndk-r17b/toolchains/llvm/prebuilt/windows-x86_64/bin/clang.exe"
 ...
 */
#define MONGOC_ENABLE_CRYPTO_SYSTEM_PROFILE 1
